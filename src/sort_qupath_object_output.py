...
def get_args():
    parser = argparse.ArgumentParser(
        description="Sorts QuPath object output into folders by class. The class has to be denoted in the file name in brackets. Every file has to have brackets with a annotation/class name in it."
    )
    parser.add_argument(
        "--root",
        type=str,
